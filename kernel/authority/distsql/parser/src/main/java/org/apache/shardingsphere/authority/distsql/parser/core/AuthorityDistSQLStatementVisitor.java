...
import org.apache.shardingsphere.distsql.parser.autogen.AuthorityDistSQLStatementParser.CreateDistUserRuleContext;
...
public final class AuthorityDistSQLStatementVisitor extends AuthorityDistSQLStatementBaseVisitor<ASTNode> implements SQLVisitor<ASTNode> {
	...
	@Override
	public ASTNode visitCreateDistUserRule(CreateDistUserRuleContext ctx) {
		return new CreateDistUserRuleStatement(ctx.userName().getText(),ctx.password().getText());
