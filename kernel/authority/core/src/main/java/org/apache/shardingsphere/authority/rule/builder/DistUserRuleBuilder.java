 ...
 * 分布式用户规则生成器
 */
public final class DistUserRuleBuilder implements GlobalRuleBuilder<UserConfiguration> {
    
	public static final int ORDER = 6000;
	
    @Override
    public DistUserRule build(final UserConfiguration ruleConfig, final Collection<ShardingSphereDatabase> databases, final ConfigurationProperties props) {
        return new DistUserRule(ruleConfig);
    }
